...
export interface AgentConfig {
  ...
  /** Timeout in ms for task responses (default: 120_000) */
  timeoutMs?: number
  /** Max concurrent tasks queued for this agent (backpressure, default: 10) */
  maxQueueSize?: number
}
...
Responde siempre en español con el contenido o resultado de la operación solicitada.`,
  ...
  },
  {
    ...
    timeoutMs: 60_000,         // lighter tasks, shorter timeout
    maxQueueSize: 20,          // receives many broadcast events
...
Indica su estado (activo/suspendido/moroso). Responde en español.`,
  ...
  },
  {
    ...
    enabled: true,
    timeoutMs: 180_000,        // complex reasoning, needs more time
